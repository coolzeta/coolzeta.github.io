...
export default function Web3Provider({ children }: { children: React.ReactNode }) {
  ...
  async function requestAccounts() {
    if (window.ethereum) {
      ...
      setError(
        'No Ethereum wallet found, please use a browser with Ethereum wallect like MetaMask to explores all contents.'
      );
    }
  }
  useEffect(() => {
